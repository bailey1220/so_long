...
/*   Updated: 2025/02/12 13:56:39 by bailey           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	void	*b; // Texture for background
	void	*w; // Texture for wall
	void	*c; // Texture for collectible
	void	*pu; // Texture for player up
	void	*pd; // Texture for player down
	void	*pl; // Texture for player left
	void	*pr; // Texture for player right
	void	*m; // Texture for monster
	void	*e; // Texture for exit
}	t_txt;
...
void	render_gamemap(t_game game, char key);
